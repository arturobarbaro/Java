...
public class Main {
    ...
    public static void main(String[] args) {
        List palabras = List.of("Botella", "Organo", "Bote", "órgano", "botella", "Órgano");
    ...
    private static void mostrarf1(List palabras) {
        ...
        System.out.println("Lista cadenas:                             "+palabras);
    ...
    private static void ordenarSinCollator(List palabras){
        comprobarList(palabras);

        String[] sinCollator = (String[]) palabras.toArray(new String[0]);
        Arrays.sort(sinCollator);

        System.out.println("Ordenación sin clase Collator:             "+ Arrays.asList(sinCollator));
    }
